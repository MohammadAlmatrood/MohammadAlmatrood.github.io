...
function iHeartYou(){
	...
	if(window.location.hash){
		...
		vtext.textContent = "I have no words to describe just how much you mean to me my love. Through every hardship and disappointment you've been such a blessing on my life, a place I can count on forever for love and warmth. You give me butterflies just like the day we first met and I've only found more things to love about you as I spend more time with you. Here's to a forever with you and a forever continuosly falling in love with you again and again <3";
	}
...
function linkChangey(){
	if(yourMessage.value==""){
		...
		yourLink.value = ""+encodeURIComponent(encryptString(yourMessage.value));
	}
};
